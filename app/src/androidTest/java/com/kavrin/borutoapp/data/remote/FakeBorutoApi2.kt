package com.kavrin.borutoapp.data.remote

import com.kavrin.borutoapp.domain.model.ApiResponse
...
class FakeBorutoApi2 : BorutoApi {
	...
	override suspend fun getAllHeroes(page: Int): ApiResponse {
		...
		return ApiResponse(
			success = true,
			message = "OK",
			prevPage = calcPage(page = page)["prevPage"],
			nextPage = calcPage(page = page)["nextPage"],
			heroes = heroes[page]!!
		)
	}
